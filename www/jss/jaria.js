	...
	nav: new function(){
		...
		$.scroll = function(){
			if( $.msie || $.opera ){
				...
				$.scrollX = (parseFloat($.version) < 6 ) ? document.body.scrollLeft : document.documentElement.scrollLeft;
				$.scrollY = (parseFloat($.version) < 6 ) ? document.body.scrollTop : document.documentElement.scrollTop;
			}
			else{
...
var oAjax = new Jaria.Ajax();
var oColor = new Jaria.Color();
>>>>>>> 99707f2c12835fb8557c397e221f6754bd45d9e7
